...
- [`../zz-drop-core/docs/commands.md`](../zz-drop-core/docs/commands.md) — short canonical pointer for the spec table.
- [`../zz-drop-core/docs/file-encryption.md`](../zz-drop-core/docs/file-encryption.md) — `.zzd` blob format (v1.1 file E2EE).
- [`../zz-drop-core/docs/feature-flags.md`](../zz-drop-core/docs/feature-flags.md) — Cargo feature lifecycle (`remote`).
